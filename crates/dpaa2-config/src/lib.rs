...
//! neutral [`dpaa2_api::intent::Intent`] the compiler consumes, and depends on the core but
//! not on any backend. It parses and validates *intent* only — turning intent plus an
//! inventory into the object plan is [`dpaa2_api::intent::refuse::compile`]'s
//! (2026-08-22-restool-baseline design D10). The
