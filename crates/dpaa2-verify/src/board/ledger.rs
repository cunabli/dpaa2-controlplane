...
//! honesty mechanism (2026-08-22-restool-baseline design D9) is broken. This module parses each
...
pub struct LintInput<'a> {
    ...
    pub index: &'a crate::board::verdict::Index,
...
fn r9_register(input: &LintInput<'_>, out: &mut Vec<String>) {
    for row in input.register {
        ...
        if row.status != "unknown" && row.status != "—" {
            match crate::board::mcstatus::by_name(&row.status) {
                None => out.push(format!(
...
mod tests {
    ...
    fn empty_index() -> crate::board::verdict::Index {
        crate::board::verdict::Index::new()
    }
    ...
    fn base_input<'a>(
        ...
        scenarios: &'a [String],
        index: &'a crate::board::verdict::Index,
...
";
    ...
    fn summ(pass: bool, date: &str, revision: u32) -> crate::board::verdict::Summary {
        crate::board::verdict::Summary {
            pass,
            date: date.to_owned(),
            kind: crate::board::verdict::Kind::Batch,
            revision,
            steps: "1/1".to_owned(),
    ...
    fn one_entry(
        suite: &str,
        label: &str,
        s: crate::board::verdict::Summary,
    ) -> crate::board::verdict::Index {
        let mut idx = crate::board::verdict::Index::new();
