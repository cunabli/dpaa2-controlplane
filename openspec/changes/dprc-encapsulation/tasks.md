...
- [ ] 2.1 Child-DPRC lifecycle typestates isomorphic to the 1.1 sum; invalid transitions unrepresentable; parity test binding Rust to the Quint sum per the ADR-0002 law
