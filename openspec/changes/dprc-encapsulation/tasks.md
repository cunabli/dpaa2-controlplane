...
- [x] 5.3 End-to-end convergence suite: intent-declared consumer converged and re-converged clean; read-back diffed against the derived model
- [x] 5.4 Online-MBT discovery sessions for the candidate containment faces (DPRC-I1 pool boundary, I9 under reconciler plans, I11 restool-reachable remainder); divergences amend model + `docs/baseline/dprc.md` in-change
