...
| 4 | `dprc-encapsulation` | Child-DPRC lifecycle + VFIO binding typestates; consumer containers; **first online-MBT discovery target** (containment/pool semantics are the most opaque MC behavior) | 2, 3 | delivered 2026-09-14 (ADR-0017; ADR-0007/0011 amendments) |
