...
| 5 | `dpni-typestate` | Extend the existing dpni support to the full baseline option surface as typestates; model + batch suite | 2, 4 | proposed 2026-09-19 (epic dpaa2-controlplane-guu) |
