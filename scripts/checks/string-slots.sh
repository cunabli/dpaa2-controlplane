...
# --- permanent: not resource names, no bounded namespace to reify into (jwu) ---
# Object.label = redacted capture (objects keyed separately, scanned for redaction, not an identity).
crates/dpaa2-verify/src/board/snapshot.rs:pub label: String,
crates/dpaa2-verify/src/board/snapshot.rs:label: String::new(),
# FitStep/FitReport.label, ProbeStep/ProbeRecord.label = free prose step description, unbounded text.
