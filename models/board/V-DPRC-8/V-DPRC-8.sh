...
# generated by dpaa2-verify from models/board/V-DPRC-8/vdprc8.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-DPRC-8.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-DPRC-8 pid $$"
...
# --- suite hook: models/board/V-DPRC-8/vfio.sh ---
...
if grep -nE 'dpmac[.]3([^0-9]|$)|dpmac[.]17([^0-9]|$)|dpni[.]0([^0-9]|$)' "models/board/V-DPRC-8/vfio.sh" | grep -v safety-self-check; then
  echo "refusing: total-deny object referenced in the hook" >&2  # safety-self-check
  exit 1
fi
. "models/board/V-DPRC-8/vfio.sh"

echo "suite V-DPRC-8 complete"
