...
# generated by dpaa2-verify from models/board/V-CEIL-1/vceil1.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-CEIL-1.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-CEIL-1 pid $$"
...
# --- suite hook: models/board/V-CEIL-1/ceil.sh ---
...
if grep -nE 'dpmac[.]3([^0-9]|$)|dpmac[.]17([^0-9]|$)|dpni[.]0([^0-9]|$)' "models/board/V-CEIL-1/ceil.sh" | grep -v safety-self-check; then
  echo "refusing: total-deny object referenced in the hook" >&2  # safety-self-check
  exit 1
fi
. "models/board/V-CEIL-1/ceil.sh"

echo "suite V-CEIL-1 complete"
