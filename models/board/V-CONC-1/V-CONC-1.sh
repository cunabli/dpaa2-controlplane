...
# generated by dpaa2-verify from models/board/V-CONC-1/vconc1.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-CONC-1.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-CONC-1 pid $$"
...
# --- suite hook: models/board/V-CONC-1/conc.sh ---
...
if grep -nE 'dpmac[.]3([^0-9]|$)|dpmac[.]17([^0-9]|$)|dpni[.]0([^0-9]|$)' "models/board/V-CONC-1/conc.sh" | grep -v safety-self-check; then
  echo "refusing: total-deny object referenced in the hook" >&2  # safety-self-check
  exit 1
fi
. "models/board/V-CONC-1/conc.sh"

echo "suite V-CONC-1 complete"
