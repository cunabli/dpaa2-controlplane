...
# generated by dpaa2-verify from models/board/V-LINK-1/vlink1.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-LINK-1.plan.json --results <dir>
set -u
