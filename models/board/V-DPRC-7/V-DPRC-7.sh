...
# generated by dpaa2-verify from models/board/V-DPRC-7/vdprc7.itf.json — do not edit; regenerate instead.
# operator: run as root — 9 steps issue MC commands the kernel gates on CAP_NET_ADMIN (docs/baseline/mc-ioctl-policy.md)
...
#   dpaa2-verify diff --plan V-DPRC-7.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-DPRC-7 pid $$"
...
teardown() {
  [ -n "${OBJ_dpbp_1:-}" ] && restool dprc assign ${OBJ_dprc_3} --object="${OBJ_dpbp_1}" --plugged=0 2>>"$RESULTS/teardown.log" || true
...
# step 2: CreateObject { fam: Dpbp, container: ObjRef { fam: Dprc, num: 2 } }
OBJ_dpbp_0="$(run_create 2 restool --script dpbp create --container=${OBJ_dprc_2})"
...
# step 3: CreateObject { fam: Dpbp, container: ObjRef { fam: Dprc, num: 3 } }
OBJ_dpbp_1="$(run_create 3 restool --script dpbp create --container=${OBJ_dprc_3})"
...
# step 4: Plug { obj: ObjRef { fam: Dpbp, num: 0 } }
run 4 restool dprc assign ${OBJ_dprc_2} --object=${OBJ_dpbp_0} --plugged=1
# expect: dpbp_0 present=true plugged=true
probe 4 0 restool dprc show ${OBJ_dprc_2}
pool_capture step-4-pool.txt

# step 5: Plug { obj: ObjRef { fam: Dpbp, num: 1 } }
run 5 restool dprc assign ${OBJ_dprc_3} --object=${OBJ_dpbp_1} --plugged=1
# expect: dpbp_1 present=true plugged=true
probe 5 0 restool dprc show ${OBJ_dprc_3}
pool_capture step-5-pool.txt

# step 6: Unplug { obj: ObjRef { fam: Dpbp, num: 0 } }
run 6 restool dprc assign ${OBJ_dprc_2} --object=${OBJ_dpbp_0} --plugged=0
# expect: dpbp_0 present=true plugged=false driver_bound=false
probe 6 0 restool dprc show ${OBJ_dprc_2}
probe_link 6 1 /sys/bus/fsl-mc/devices/${OBJ_dpbp_0}/driver
pool_capture step-6-pool.txt

# step 7: Destroy { obj: ObjRef { fam: Dprc, num: 2 } }
run 7 restool dprc destroy ${OBJ_dprc_2}
