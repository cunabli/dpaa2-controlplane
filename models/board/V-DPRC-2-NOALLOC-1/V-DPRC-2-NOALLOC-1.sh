#!/bin/sh
# suite: V-DPRC-2-NOALLOC-1
# class: object-lifecycle-only
# generated by dpaa2-verify from models/board/V-DPRC-2-NOALLOC-1/vdprc2noalloc.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-DPRC-2-NOALLOC-1.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-DPRC-2-NOALLOC-1 pid $$"
...
OBJ_dprc_2="$(run_create 0 restool --script dprc create dprc.1 --options=DPRC_CFG_OPT_SPAWN_ALLOWED,DPRC_CFG_OPT_OBJ_CREATE_ALLOWED,DPRC_CFG_OPT_IRQ_CFG_ALLOWED)"
...
# expect: refused with No resources
probe 1 0 restool dprc show ${OBJ_dprc_2}

echo "suite V-DPRC-2-NOALLOC-1 complete"
