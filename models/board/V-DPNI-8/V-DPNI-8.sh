...
# generated by dpaa2-verify from models/board/V-DPNI-8/vdpni8.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-DPNI-8.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-DPNI-8 pid $$"
...
# --- suite hook: models/board/V-DPNI-8/sizing.sh ---
...
if grep -nE 'dpmac[.]3([^0-9]|$)|dpmac[.]17([^0-9]|$)|dpni[.]0([^0-9]|$)' "models/board/V-DPNI-8/sizing.sh" | grep -v safety-self-check; then
  echo "refusing: total-deny object referenced in the hook" >&2  # safety-self-check
  exit 1
fi
. "models/board/V-DPNI-8/sizing.sh"

echo "suite V-DPNI-8 complete"
