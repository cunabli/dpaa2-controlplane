#!/bin/sh
# suite: V-DPRC-2-NOCREATE-1
# class: object-lifecycle-only
# generated by dpaa2-verify from models/board/V-DPRC-2-NOCREATE-1/vdprc2nocreate.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-DPRC-2-NOCREATE-1.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-DPRC-2-NOCREATE-1 pid $$"
...
OBJ_dprc_2="$(run_create 0 restool --script dprc create dprc.1 --options=DPRC_CFG_OPT_SPAWN_ALLOWED,DPRC_CFG_OPT_ALLOC_ALLOWED,DPRC_CFG_OPT_IRQ_CFG_ALLOWED)"
...
echo "suite V-DPRC-2-NOCREATE-1 complete"
