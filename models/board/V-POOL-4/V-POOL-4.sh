...
# generated by dpaa2-verify from models/board/V-POOL-4/vpool4.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-POOL-4.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-POOL-4 pid $$"
...
# --- suite hook: models/board/V-POOL-4/pool4.sh ---
...
if grep -nE 'dpmac[.]3([^0-9]|$)|dpmac[.]17([^0-9]|$)|dpni[.]0([^0-9]|$)' "models/board/V-POOL-4/pool4.sh" | grep -v safety-self-check; then
  echo "refusing: total-deny object referenced in the hook" >&2  # safety-self-check
  exit 1
fi
. "models/board/V-POOL-4/pool4.sh"

echo "suite V-POOL-4 complete"
