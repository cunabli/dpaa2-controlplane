...
| V-DPRC-9 | `intent-a.toml` + `intent-b.toml` (hand-authored `dpaa2ctl` suite) | authored 2026-09-14 (dprc-encapsulation task 5.3, bead dpaa2-controlplane-cd3.12); pending first sitting |
