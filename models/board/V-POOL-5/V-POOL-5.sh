...
# generated by dpaa2-verify from models/board/V-POOL-5/vpool5.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-POOL-5.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-POOL-5 pid $$"
...
# step 0: CreateObject { fam: Dpbp, container: ObjRef { fam: Dprc, num: 1 } }
OBJ_dpbp_0="$(run_create 0 restool --script dpbp create --container=dprc.1)"
...
# --- suite hook: models/board/V-POOL-5/ceiling.sh ---
...
if grep -nE 'dpmac[.]3([^0-9]|$)|dpmac[.]17([^0-9]|$)|dpni[.]0([^0-9]|$)' "models/board/V-POOL-5/ceiling.sh" | grep -v safety-self-check; then
  echo "refusing: total-deny object referenced in the hook" >&2  # safety-self-check
  exit 1
fi
. "models/board/V-POOL-5/ceiling.sh"

echo "suite V-POOL-5 complete"
