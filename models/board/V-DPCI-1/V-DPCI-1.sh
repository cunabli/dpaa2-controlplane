...
# generated by dpaa2-verify from models/board/V-DPCI-1/vdpci1.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-DPCI-1.plan.json --results <dir>
set -u
...
# expect: dpci_0 endpoint=dpci_1
probe 3 0 restool dpci info ${OBJ_dpci_0}

# step 4: Destroy { obj: ObjRef { fam: Dpci, num: 0 } }
run 4 restool dpci destroy ${OBJ_dpci_0}
# expect: dpci_0 present=false
probe 4 0 restool dprc show ${OBJ_dprc_2}

# step 5: Destroy { obj: ObjRef { fam: Dpci, num: 1 } }
run 5 restool dpci destroy ${OBJ_dpci_1}
# expect: dpci_1 present=false
probe 5 0 restool dprc show ${OBJ_dprc_2}

# step 6: Destroy { obj: ObjRef { fam: Dprc, num: 2 } }
run 6 restool dprc destroy ${OBJ_dprc_2}
# expect: dprc_2 present=false
probe 6 0 restool dprc show dprc.1

echo "suite V-DPCI-1 complete"
