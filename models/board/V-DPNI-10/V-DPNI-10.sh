...
# generated by dpaa2-verify from models/board/V-DPNI-10/vdpni10.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-DPNI-10.plan.json --results <dir>
set -u
...
KMSG="dpaa2-verify V-DPNI-10 pid $$"
...
# --- suite hook: models/board/V-DPNI-10/mac.sh ---
...
if grep -nE 'dpmac[.]3([^0-9]|$)|dpmac[.]17([^0-9]|$)|dpni[.]0([^0-9]|$)' "models/board/V-DPNI-10/mac.sh" | grep -v safety-self-check; then
  echo "refusing: total-deny object referenced in the hook" >&2  # safety-self-check
  exit 1
fi
. "models/board/V-DPNI-10/mac.sh"

echo "suite V-DPNI-10 complete"
