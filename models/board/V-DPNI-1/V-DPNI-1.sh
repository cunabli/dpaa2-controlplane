...
# generated by dpaa2-verify from models/board/V-DPNI-1/vdpni1.itf.json — do not edit; regenerate instead.
...
#   dpaa2-verify diff --plan V-DPNI-1.plan.json --results <dir>
set -u
...
# step 2: Plug { obj: ObjRef { fam: Dpni, num: 0 } }
run 2 restool dprc assign ${OBJ_dprc_2} --object=${OBJ_dpni_0} --plugged=1
# expect: dpni_0 present=true plugged=true
probe 2 0 restool dprc show ${OBJ_dprc_2}

# step 3: Destroy { obj: ObjRef { fam: Dpni, num: 0 } }
run 3 restool dpni destroy ${OBJ_dpni_0}
